...
(
    ...
    recycle_time BIGINT(20)  DEFAULT '0' COMMENT '回收时间，过期前恢复文件',
    deleted      TINYINT(1)  DEFAULT 0 COMMENT '是否删除，0未删除，1删除',
    create_time  DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
    update_time  DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '更新时间',
    PRIMARY KEY (id),
...
(
    id          BIGINT(20) NOT NULL AUTO_INCREMENT COMMENT '缩略图id',
...
(
    ...
    width             INT(11)      DEFAULT '0' COMMENT '视频分辨率宽度',
    height            INT(11)      DEFAULT '1080' COMMENT '视频分辨率高度',
    ...
    codec             VARCHAR(10)  DEFAULT 'h264' COMMENT '编码器',
    audio_codec       VARCHAR(10)  DEFAULT 'aac' COMMENT '音频编码器',
...
(
    ...
    progress      DOUBLE(11, 1) DEFAULT '0.0' COMMENT '转码进度',
    trans_status  TINYINT(1)    DEFAULT '0' COMMENT '文件转码状态',
    start_time    BIGINT(20)    DEFAULT '0' COMMENT '转码开始时间',
    end_time      BIGINT(20)    DEFAULT '0' COMMENT '转码结束时间',
    message       VARCHAR(255)  DEFAULT '' COMMENT '转码信息',
    deleted       TINYINT(1)    DEFAULT 0 COMMENT '是否删除，0未删除，1删除',
    create_time   DATETIME(3)   DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
    update_time   DATETIME(3)   DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '更新时间',
    PRIMARY KEY (id),
...
('demo', '$2a$10$C5LAWEU.5HoX91ve2D7Iv.kJGlJuWt5P.on5sgCuIttsMasWe5ftu', '演示用户', 1)
...
SELECT 'Default users: admin / 123456, demo / 123456' AS hint;
