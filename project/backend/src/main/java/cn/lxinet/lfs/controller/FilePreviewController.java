...
public class FilePreviewController {
    ...
    public ResponseEntity<Resource> preview(
        ...
        String path = normalizeRequestPath(requestUri);
     ...
     * 验证防盗链
     */
    static String normalizeRequestPath(String requestUri) {
        if (StringUtils.startsWith(requestUri, "/api/files/")
                || StringUtils.startsWith(requestUri, "/api/thum/")
                || StringUtils.startsWith(requestUri, "/api/trans/")) {
